...
if (!fs.existsSync('./data')) {
  fs.mkdirSync('./data');
  const defaultFiles = ['cameras.json', 'doors.json', 'servers.json', 'switches.json', 'tickets.json', 'audit.json', 'inbox.json', 'clients.json', 'software.json'];
...
app.listen(PORT, () => {
  ...
  console.log(`📊 Data stats:`, getFileStats());
